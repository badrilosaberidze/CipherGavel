...
A confidential sealed-bid **Vickrey auction** built on Zama's fhEVM. Every bid — and even the seller's reserve price —
is encrypted end-to-end. The winner and the second-highest (clearing) price are computed directly on the encrypted bids
and are the only values ever revealed; losing bids stay encrypted forever.

    ...
    <div className="wrap">
      ...
      <header className="topbar">
        ...
        <div className="topbar-right">
          <span className="pill"><span className="dot" /> Sepolia · demo</span>
          <button className="btn btn-ghost" onClick={() => alert("Wallet connection arrives in the next build — this is the design preview.")}>
            Connect wallet
          </button>
        </div>
      </header>
          ...
          <div className="paddles">
            ...
            <AnimatePresence>
              {bids.map((bid) => {
                ...
                const showValue = phase === "revealed" && isWinner; // only the winner is unsealed
                return (
                  <motion.div
                    key={bid.id}
                    layout
